...
//It is using a lexical scope which is external variable or context being referenced by a function.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
     const animalArray = [...array];
     const displayNames = [];
     animalArray.forEach(animal => {displayNames.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`)});
    return displayNames;
  }
  ...
  */
  ...
  function lowerCaseNames(){
    const lowerCaseArr = zooAnimals.map((element) => {
  ...
  */
  ...
  function lowPopulationAnimals(){
    const lowPopArr = zooAnimals.filter((element) => {
  ...
  */
  ...
  function USApop(){
    const fullPopArr = zooAnimals.reduce((accumulator, currentValue) => {
